...
(function (SereneLargeFileUpload) {
    ...
    })(Administration = SereneLargeFileUpload.Administration || (SereneLargeFileUpload.Administration = {}));
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = SereneLargeFileUpload.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = SereneLargeFileUpload.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = SereneLargeFileUpload.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (SereneLargeFileUpload) {
    ...
    })(Common = SereneLargeFileUpload.Common || (SereneLargeFileUpload.Common = {}));
})(SereneLargeFileUpload || (SereneLargeFileUpload = {}));
var SereneLargeFileUpload;
(function (SereneLargeFileUpload) {
    var Common;
...
(function (SereneLargeFileUpload) {
    ...
    })(Membership = SereneLargeFileUpload.Membership || (SereneLargeFileUpload.Membership = {}));
})(SereneLargeFileUpload || (SereneLargeFileUpload = {}));
var SereneLargeFileUpload;
(function (SereneLargeFileUpload) {
    var Membership;
...
(function (SereneLargeFileUpload) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'SereneLargeFileUpload.Northwind.Gender', 'SereneLargeFileUpload.Northwind.Entities.Gender');
    })(Northwind = SereneLargeFileUpload.Northwind || (SereneLargeFileUpload.Northwind = {}));
})(SereneLargeFileUpload || (SereneLargeFileUpload = {}));
var SereneLargeFileUpload;
(function (SereneLargeFileUpload) {
...
(function (SereneLargeFileUpload) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'SereneLargeFileUpload.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = SereneLargeFileUpload.Northwind || (SereneLargeFileUpload.Northwind = {}));
})(SereneLargeFileUpload || (SereneLargeFileUpload = {}));
var SereneLargeFileUpload;
(function (SereneLargeFileUpload) {
        ...
        var RegionForm = /** @class */ (function (_super) {
            ...
            function RegionForm(prefix) {
                ...
                if (!RegionForm.init) {
                    ...
                    var w3 = SereneLargeFileUpload.LargeFileUploadEditor;
...
(function (SereneLargeFileUpload) {
    ...
    })(Authorization = SereneLargeFileUpload.Authorization || (SereneLargeFileUpload.Authorization = {}));
})(SereneLargeFileUpload || (SereneLargeFileUpload = {}));
var SereneLargeFileUpload;
(function (SereneLargeFileUpload) {
    var Administration;
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneLargeFileUpload.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(SereneLargeFileUpload.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(SereneLargeFileUpload.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneLargeFileUpload.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        SereneLargeFileUpload.Common.ReportHelper.execute({
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: SereneLargeFileUpload.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: SereneLargeFileUpload.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new SereneLargeFileUpload.Northwind.OrderDialog();
                        ...
                        var chai = SereneLargeFileUpload.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = SereneLargeFileUpload.Northwind.EmployeeRow.getLookup().items
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(SereneLargeFileUpload.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    SereneLargeFileUpload.Northwind.CategoryService.Retrieve({
        ...
        }(SereneLargeFileUpload.Northwind.CategoryDialog));
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneLargeFileUpload.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(SereneLargeFileUpload.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new SereneLargeFileUpload.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                SereneLargeFileUpload.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(SereneLargeFileUpload.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    SereneLargeFileUpload.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(SereneLargeFileUpload.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(SereneLargeFileUpload.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    SereneLargeFileUpload.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return SereneLargeFileUpload.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return SereneLargeFileUpload.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return SereneLargeFileUpload.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return SereneLargeFileUpload.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return SereneLargeFileUpload.LanguageList.getValue();
            };
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneLargeFileUpload.Northwind.SupplierDialog));
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                SereneLargeFileUpload.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    SereneLargeFileUpload.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(SereneLargeFileUpload.Northwind.CustomerDialog));
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneLargeFileUpload.Northwind.CustomerGrid));
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = SereneLargeFileUpload.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return SereneLargeFileUpload.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(SereneLargeFileUpload.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return SereneLargeFileUpload.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new SereneLargeFileUpload.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(SereneLargeFileUpload.Northwind.OrderDetailDialog));
...
(function (SereneLargeFileUpload) {
    ...
    (function (Northwind) {
        ...
        }(SereneLargeFileUpload.Common.GridEditorBase));
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneLargeFileUpload.Northwind.OrderDetailsEditor));
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return SereneLargeFileUpload.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return SereneLargeFileUpload.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return SereneLargeFileUpload.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return SereneLargeFileUpload.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return SereneLargeFileUpload.Northwind.CategoryRow.lookupKey;
            };
            /**
    ...
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new SereneLargeFileUpload.BasicProgressDialog();
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneLargeFileUpload.Common.BulkServiceAction));
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return SereneLargeFileUpload.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return SereneLargeFileUpload.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return SereneLargeFileUpload.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return SereneLargeFileUpload.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(SereneLargeFileUpload.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new SereneLargeFileUpload.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new SereneLargeFileUpload.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new SereneLargeFileUpload.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (SereneLargeFileUpload) {
    ...
    SereneLargeFileUpload.SelectableEntityGrid = SelectableEntityGrid;
})(SereneLargeFileUpload || (SereneLargeFileUpload = {}));
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return SereneLargeFileUpload.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return SereneLargeFileUpload.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return SereneLargeFileUpload.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return SereneLargeFileUpload.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(SereneLargeFileUpload.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = SereneLargeFileUpload.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            SereneLargeFileUpload.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return SereneLargeFileUpload.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return SereneLargeFileUpload.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return SereneLargeFileUpload.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return SereneLargeFileUpload.Northwind.ProductService.baseUrl; };
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return SereneLargeFileUpload.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return SereneLargeFileUpload.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return SereneLargeFileUpload.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return SereneLargeFileUpload.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return SereneLargeFileUpload.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return SereneLargeFileUpload.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (SereneLargeFileUpload) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return SereneLargeFileUpload.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return SereneLargeFileUpload.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return SereneLargeFileUpload.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (SereneLargeFileUpload) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = SereneLargeFileUpload.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = SereneLargeFileUpload.LanguageList || (SereneLargeFileUpload.LanguageList = {}));
})(SereneLargeFileUpload || (SereneLargeFileUpload = {}));
...
(function (SereneLargeFileUpload) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = SereneLargeFileUpload.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = SereneLargeFileUpload.ScriptInitialization || (SereneLargeFileUpload.ScriptInitialization = {}));
})(SereneLargeFileUpload || (SereneLargeFileUpload = {}));
var SereneLargeFileUpload;
(function (SereneLargeFileUpload) {
    ...
    SereneLargeFileUpload.BasicProgressDialog = BasicProgressDialog;
})(SereneLargeFileUpload || (SereneLargeFileUpload = {}));
var SereneLargeFileUpload;
(function (SereneLargeFileUpload) {
    var DialogUtils;
    ...
    })(DialogUtils = SereneLargeFileUpload.DialogUtils || (SereneLargeFileUpload.DialogUtils = {}));
})(SereneLargeFileUpload || (SereneLargeFileUpload = {}));
var SereneLargeFileUpload;
(function (SereneLargeFileUpload) {
    var Common;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: SereneLargeFileUpload.Authorization.userDefinition.DisplayName,
